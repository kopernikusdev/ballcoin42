...
/** Utility functions used by the BALLCOIN Qt UI.
 */
namespace GUIUtil
{
...
// Render BALLCOIN addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZball = false);
...
// Parse "ballcoin:" URI into recipient object, return true on successful parsing
