...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("BALLCOIN Core"),
     ...
     * override -datadir in the ballcoin.conf file in the default data directory
     * (to be consistent with ballcoind behavior)
     */
