...
#include "qt/ballcoin/masternodeswidget.h"
#include "qt/ballcoin/forms/ui_masternodeswidget.h"

#include "qt/ballcoin/qtutils.h"
#include "qt/ballcoin/mnrow.h"
#include "qt/ballcoin/mninfodialog.h"
#include "qt/ballcoin/masternodewizarddialog.h"
...
#include "util.h"
#include "qt/ballcoin/optionbutton.h"
#include <iostream>
#include <fstream>
...
MasterNodesWidget::MasterNodesWidget(BALLCOINGUI *parent) :
    PWidget(parent),
...
void MasterNodesWidget::onCreateMNClicked()
{
    ...
    if (walletModel->getBalance() <= (COIN * 5000)) {
        inform(tr("Not enough balance to create a masternode, 5000 %1 required.").arg(CURRENCY_UNIT.c_str()));
        return;
    }
    showHideOp(true);
