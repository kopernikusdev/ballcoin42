...
/** 
    ...
    ****Note - for BALLCOIN we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of ballcoin coming in to a transaction
