...
#ifndef BALLCOIN_STAKEINPUT_H
#define BALLCOIN_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZBALL() const = 0;
    virtual CDataStream GetUniqueness() const = 0;
    virtual bool ContextCheck(int nHeight, uint32_t nTime) = 0;
};


class CBallStake : public CStakeInput
{
private:
...
public:
    ...
    bool IsZBALL() const override { return false; }
    bool ContextCheck(int nHeight, uint32_t nTime) override;
};


#endif //BALLCOIN_STAKEINPUT_H
