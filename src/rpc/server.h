...
/**
 * BALLCOIN RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzballseed(const JSONRPCRequest& request);
extern UniValue getzballseed(const JSONRPCRequest& request);
extern UniValue generatemintlist(const JSONRPCRequest& request);
extern UniValue searchdzball(const JSONRPCRequest& request);
extern UniValue dzballstate(const JSONRPCRequest& request);
