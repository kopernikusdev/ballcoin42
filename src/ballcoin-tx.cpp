...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("BALLcoin Core ballcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ballcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ballcoin transaction") + "\n" +
                               "  ballcoin-tx [options] -create [commands]   " + _("Create hex-encoded ballcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ballcoin transaction
