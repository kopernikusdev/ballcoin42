Contributing to BALLCOIN Core
============================

The BALLCOIN Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/kopernikusdev/ballcoin42/blob/master/doc/translation_process.md)
...
The following applies to code changes to the BALLCOIN Core project, and is not to be
confused with overall BALLCOIN Network Protocol consensus changes.

Whether a pull request is merged into BALLCOIN Core rests with the project merge
...
Patches that change BALLCOIN consensus rules are considerably more involved than
...
Where a patchset proposes to change the BALLCOIN consensus, it must have been
...
The project leader is the release manager for each BALLCOIN Core release.
