PIVX Core version *3.2.0* is now available from:  <https://github.com/kopernikusdev/ballcoin42/releases>
...
A full report provided by PIVX developers is available on the [PIVX Website](https://ball-coin.com/fake-stake-official-pivx-report/), which includes additional findings, mitigation details, and resources for testing. This type of attack has no risk to users' privacy and does not affect their holdings.
