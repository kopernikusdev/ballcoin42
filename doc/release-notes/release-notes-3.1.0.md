BALLCOIN Core version *3.1.0* is now available from:  <https://github.com/kopernikusdev/ballcoin42/releases>
...
- zballbackuppath = <directory / full path>
...
* If zBALL backup, auto generated name is `wallet-autozballbackup.dat-<year>-<month>-<day>-<hour>-<minute>-<second>`
...
### GUI
 ...
 - #467 `7099831bd` [Qt] Clear PrivacyDialog "zBall Selected" labels after sending. (presstab)
