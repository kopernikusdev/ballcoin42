...
from test_framework.test_framework import BALLcoinTestFramework
...
class ReorgStakeTest(BALLcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Check BALL and zBALL supply at the beginning
        # ------------------------------------------
        # zBALL supply: 2 coins for each denomination
        expected_zball_supply = {
            "1": 2,
            "5": 10,
            "10": 20,
            "50": 100,
        ...
        # BALL supply: block rewards minus burned fees for minting
        expected_money_supply = 250.0 * 330 - 16 * 0.01
        self.check_money_supply(expected_money_supply, expected_zball_supply)
        ...
        # Verify that BALL and zBALL supplies were properly updated after the spends and reorgs
        self.log.info("Check BALL and zBALL supply...")
        ...
        expected_zball_supply[str(spent_coin_0)] -= spent_coin_0
        expected_zball_supply[str(spent_coin_1)] -= spent_coin_1
        expected_zball_supply["total"] -= (spent_coin_0 + spent_coin_1)
        self.check_money_supply(expected_money_supply, expected_zball_supply)
